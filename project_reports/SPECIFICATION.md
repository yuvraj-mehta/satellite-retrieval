...
- [x] Visualization script renders SAR and optical side-by-side correctly
- [x] MVP ResNet50 pipeline extracts embeddings and retrieves Top-5 / Top-10 results
- [x] FAISS index builds in < 5 seconds on M1 for the full subset
- [x] Contrastive dual-encoder trained with InfoNCE loss achieves improved F1 vs MVP
- [x] Evaluation script reports F1@5 and F1@10 for same-modal and cross-modal retrieval
- [x] Retrieval time per query < 100ms
- [x] Code is clean, modular, and ready for submission
